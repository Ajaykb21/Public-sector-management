...
$dept_name="";
    ...
    {    
        switch($dist)
            {
                case 'a':$query="SELECT * FROM tourism WHERE t_dist BETWEEN 0 AND 5";
                        break;
                case 'b':$query="SELECT * FROM tourism WHERE t_dist BETWEEN 6 AND 10";
                        break;
                case 'c':$query="SELECT * FROM tourism WHERE t_dist BETWEEN 11 AND 15";
                        break;
                case 'd':$query="SELECT * FROM tourism WHERE t_dist > 15";
                        break;
            }
    }
    ...
    {   
        switch($rate)
            {
                case 'a':$query="SELECT * FROM tourism WHERE t_rate>=4";
                        break;
                case 'b':$query="SELECT * FROM tourism WHERE t_rate>=3";
                        break;
                case 'c':$query="SELECT * FROM tourism WHERE t_rate>=2";
                        break;       
            }
    }
    ...
    {    
	    ...
	    for($j=$ele;$j<$loop;$j++)	
	    {
		    echo "<a href='tourdisp.php?id={$h_id[$j]}'>
